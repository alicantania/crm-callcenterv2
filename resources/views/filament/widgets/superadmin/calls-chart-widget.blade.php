<div>
    <div class="mb-4">
        <div class="flex justify-between items-center">
            <h3 class="text-base font-semibold text-gray-900 dark:text-gray-100">Llamadas por periodo</h3>
    ...
    <div class="h-64">
        ...
        <div class="h-full flex items-center justify-center bg-gray-100 dark:bg-gray-800 rounded-lg">
            <div class="text-center">
                <p class="text-gray-500 dark:text-gray-400">Gráfico de llamadas por {{ $period === 'day' ? 'hora' : ($period === 'week' ? 'día de la semana' : 'día del mes') }}</p>
